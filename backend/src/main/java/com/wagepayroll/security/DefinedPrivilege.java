...
public enum DefinedPrivilege {
	...
	WORK_TIME_VIEW("WORK_TIME_VIEW", "VIEW", "WORK_TIME"),
	WORK_TIME_MANAGE("WORK_TIME_MANAGE", "EDIT", "WORK_TIME"),

	PAY_PERIOD_VIEW("PAY_PERIOD_VIEW", "VIEW", "PAY_PERIOD"),
	PAY_PERIOD_MANAGE("PAY_PERIOD_MANAGE", "EDIT", "PAY_PERIOD"),
	PAY_PERIOD_RUN_VIEW("PAY_PERIOD_RUN_VIEW", "VIEW", "PAY_PERIOD_RUN"),
	PAY_PERIOD_RUN_MANAGE("PAY_PERIOD_RUN_MANAGE", "EDIT", "PAY_PERIOD_RUN");
