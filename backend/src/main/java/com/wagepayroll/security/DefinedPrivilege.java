...
public enum DefinedPrivilege {
	...
	BANK_TEMPLATE_VIEW("BANK_TEMPLATE_VIEW", "VIEW", "BANK_TEMPLATE"),
	BANK_TEMPLATE_MANAGE("BANK_TEMPLATE_MANAGE", "EDIT", "BANK_TEMPLATE"),
	...
	PAY_PERIOD_SUPERVISOR_APPROVE("PAY_PERIOD_SUPERVISOR_APPROVE", "EDIT", "PAY_PERIOD"),

	PAYMENT_LOCATION_VIEW("PAYMENT_LOCATION_VIEW", "VIEW", "PAYMENT_LOCATION"),
	PAYMENT_LOCATION_MANAGE("PAYMENT_LOCATION_MANAGE", "EDIT", "PAYMENT_LOCATION"),

	WAGE_COMPONENT_VIEW("WAGE_COMPONENT_VIEW", "VIEW", "WAGE_COMPONENT"),
	WAGE_COMPONENT_MANAGE("WAGE_COMPONENT_MANAGE", "EDIT", "WAGE_COMPONENT"),

	EMPLOYEE_PAYROLL_STANDING_VIEW("EMPLOYEE_PAYROLL_STANDING_VIEW", "VIEW", "EMPLOYEE_PAYROLL_STANDING"),
	EMPLOYEE_PAYROLL_STANDING_MANAGE("EMPLOYEE_PAYROLL_STANDING_MANAGE", "EDIT", "EMPLOYEE_PAYROLL_STANDING");
