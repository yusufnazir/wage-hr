...
/**
 * M11 bank template privileges (global catalog + demo tenant admin/viewer grants).
 */
public class DataM11PlatformBankTemplatePrivileges1 implements CustomTaskChange {
	...
	private static final UUID PRIV_BANK_TEMPLATE_VIEW = UUID.fromString("20000000-0000-0000-0000-000000000031");
	private static final UUID PRIV_BANK_TEMPLATE_MANAGE = UUID.fromString("20000000-0000-0000-0000-000000000032");
	...
	public String getConfirmationMessage() {
		return "M11 bank template privileges seeded";
	}
