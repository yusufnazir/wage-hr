...
@Entity
@Table(name = "platform_wage_component_template_base_effect")
public class PlatformWageComponentTemplateBaseEffectEntity extends WageComponentBaseEffectColumns {
