...
public final class AuditActionCodes {
	...
	public static final String PLATFORM_PAYROLL_BASE_CREATED = "PLATFORM_PAYROLL_BASE_CREATED";
	public static final String PLATFORM_PAYROLL_BASE_UPDATED = "PLATFORM_PAYROLL_BASE_UPDATED";
	public static final String PLATFORM_PAYROLL_BASE_ACTIVATED = "PLATFORM_PAYROLL_BASE_ACTIVATED";
	public static final String PLATFORM_PAYROLL_BASE_DEACTIVATED = "PLATFORM_PAYROLL_BASE_DEACTIVATED";

	public static final String PLATFORM_COUNTRY_TAX_RULE_CREATED = "PLATFORM_COUNTRY_TAX_RULE_CREATED";
	public static final String PLATFORM_COUNTRY_TAX_RULE_UPDATED = "PLATFORM_COUNTRY_TAX_RULE_UPDATED";
	public static final String PLATFORM_COUNTRY_TAX_RULE_ACTIVATED = "PLATFORM_COUNTRY_TAX_RULE_ACTIVATED";
	public static final String PLATFORM_COUNTRY_TAX_RULE_DEACTIVATED = "PLATFORM_COUNTRY_TAX_RULE_DEACTIVATED";
	...
	public static final String PLATFORM_LEDGER_TEMPLATE_CREATED = "PLATFORM_LEDGER_TEMPLATE_CREATED";

	public static final String PLATFORM_LEDGER_TEMPLATE_UPDATED = "PLATFORM_LEDGER_TEMPLATE_UPDATED";

	public static final String PLATFORM_LEDGER_TEMPLATE_ACTIVATED = "PLATFORM_LEDGER_TEMPLATE_ACTIVATED";

	public static final String PLATFORM_LEDGER_TEMPLATE_DEACTIVATED = "PLATFORM_LEDGER_TEMPLATE_DEACTIVATED";

	public static final String PLATFORM_WAGE_COMPONENT_TEMPLATE_LEDGER_LINKS_UPDATED = "PLATFORM_WAGE_COMPONENT_TEMPLATE_LEDGER_LINKS_UPDATED";

	public static final String PLATFORM_WAGE_COMPONENT_TEMPLATE_CREATED = "PLATFORM_WAGE_COMPONENT_TEMPLATE_CREATED";

	public static final String PLATFORM_WAGE_COMPONENT_TEMPLATE_UPDATED = "PLATFORM_WAGE_COMPONENT_TEMPLATE_UPDATED";

	public static final String PLATFORM_WAGE_COMPONENT_TEMPLATE_DELETED = "PLATFORM_WAGE_COMPONENT_TEMPLATE_DELETED";

	public static final String PLATFORM_WAGE_COMPONENT_TEMPLATE_DEPENDENCIES_UPDATED = "PLATFORM_WAGE_COMPONENT_TEMPLATE_DEPENDENCIES_UPDATED";
	...
	public static final String PAYMENT_LOCATION_CREATED = "PAYMENT_LOCATION_CREATED";

	public static final String PAYMENT_LOCATION_UPDATED = "PAYMENT_LOCATION_UPDATED";

	public static final String PAYMENT_LOCATION_ACTIVATED = "PAYMENT_LOCATION_ACTIVATED";

	public static final String PAYMENT_LOCATION_DEACTIVATED = "PAYMENT_LOCATION_DEACTIVATED";

	public static final String EMPLOYEE_PAYROLL_STANDING_INSTRUCTION_CREATED = "EMPLOYEE_PAYROLL_STANDING_INSTRUCTION_CREATED";

	public static final String EMPLOYEE_PAYROLL_STANDING_INSTRUCTION_UPDATED = "EMPLOYEE_PAYROLL_STANDING_INSTRUCTION_UPDATED";

	public static final String PAYROLL_PERIOD_INPUTS_MATERIALIZED = "PAYROLL_PERIOD_INPUTS_MATERIALIZED";

	public static final String TENANT_WAGE_COMPONENT_TRANSACTION_UPDATED = "TENANT_WAGE_COMPONENT_TRANSACTION_UPDATED";

	public static final String PLATFORM_COMPONENT_GROUP_TEMPLATE_CREATED = "PLATFORM_COMPONENT_GROUP_TEMPLATE_CREATED";

	public static final String PLATFORM_COMPONENT_GROUP_TEMPLATE_UPDATED = "PLATFORM_COMPONENT_GROUP_TEMPLATE_UPDATED";

	public static final String PLATFORM_COMPONENT_GROUP_TEMPLATE_DELETED = "PLATFORM_COMPONENT_GROUP_TEMPLATE_DELETED";

	public static final String PLATFORM_COMPONENT_HEADER_TEMPLATE_CREATED = "PLATFORM_COMPONENT_HEADER_TEMPLATE_CREATED";

	public static final String PLATFORM_COMPONENT_HEADER_TEMPLATE_UPDATED = "PLATFORM_COMPONENT_HEADER_TEMPLATE_UPDATED";

	public static final String PLATFORM_COMPONENT_HEADER_TEMPLATE_DELETED = "PLATFORM_COMPONENT_HEADER_TEMPLATE_DELETED";

	public static final String PLATFORM_COMPONENT_ITEM_TEMPLATE_CREATED = "PLATFORM_COMPONENT_ITEM_TEMPLATE_CREATED";

	public static final String PLATFORM_COMPONENT_ITEM_TEMPLATE_UPDATED = "PLATFORM_COMPONENT_ITEM_TEMPLATE_UPDATED";

	public static final String PLATFORM_COMPONENT_ITEM_TEMPLATE_DELETED = "PLATFORM_COMPONENT_ITEM_TEMPLATE_DELETED";

	public static final String TENANT_COMPONENT_GROUP_CREATED = "TENANT_COMPONENT_GROUP_CREATED";

	public static final String TENANT_COMPONENT_GROUP_UPDATED = "TENANT_COMPONENT_GROUP_UPDATED";

	public static final String TENANT_COMPONENT_GROUP_DELETED = "TENANT_COMPONENT_GROUP_DELETED";

	public static final String TENANT_COMPONENT_HEADER_CREATED = "TENANT_COMPONENT_HEADER_CREATED";

	public static final String TENANT_COMPONENT_HEADER_UPDATED = "TENANT_COMPONENT_HEADER_UPDATED";

	public static final String TENANT_COMPONENT_HEADER_DELETED = "TENANT_COMPONENT_HEADER_DELETED";

	public static final String TENANT_COMPONENT_ITEM_CREATED = "TENANT_COMPONENT_ITEM_CREATED";

	public static final String TENANT_COMPONENT_ITEM_UPDATED = "TENANT_COMPONENT_ITEM_UPDATED";

	public static final String TENANT_COMPONENT_ITEM_DELETED = "TENANT_COMPONENT_ITEM_DELETED";
