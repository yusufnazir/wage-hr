...
- **Platform operator APIs:** `platform_superadmin` gates **`GET /api/v1/platform/privileges/catalog`**, **`/api/v1/platform/settings`**, **`GET/POST /api/v1/platform/tenants`**, **`GET/PATCH /api/v1/platform/tenants/{tenantId}`**, and **`PUT /api/v1/platform/tenants/{tenantId}/privilege-pool`** (tenant pool replacement — see [`platform-settings.md`](./platform-settings.md), [`platform-tenant-admin.md`](./platform-tenant-admin.md)).
