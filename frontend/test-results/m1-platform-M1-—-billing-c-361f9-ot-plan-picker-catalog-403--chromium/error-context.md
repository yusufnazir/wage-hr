...
- Name: m1-platform.spec.ts >> M1 — billing catalog privilege >> viewer sees billing summary but not plan picker (catalog 403)
- Location: e2e\m1-platform.spec.ts:111:7
...
Locator: getByTestId('billing-summary-section')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('billing-summary-section')
